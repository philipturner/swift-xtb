...
if [[ $build_documentation == true ]]; then
  ...
  swift package --allow-writing-to-directory docs generate-documentation --target xTB --transform-for-static-hosting --output-path docs --hosting-base-path swift-xtb
  echo '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta http-equiv="refresh" content="0;url=https://philipturner.github.io/swift-xtb/documentation/xtb">' > docs/index.html
fi
