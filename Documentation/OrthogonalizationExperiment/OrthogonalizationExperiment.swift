//
//  OrthogonalizationExperiment.swift
//
//
//  Created by Philip Turner on 2/14/24.
//

// While running this experiment, I found an issue with the diagonalization
// failing to diverge. I used the same approach that worked for 3x3 matrices in
// MM4RigidBody, but it wouldn't converge to a reasonable wavefunction. I then
// started reproducing the INQ tests for eigensolvers.
//
// The purpose of this experiment was testing a more parallel orthogonalization
// algorithm. It is similar to forcefields and energy minimization. It seems
// more economical to test the new algorithm on INQ's plethora of unit tests.
// Reproducing their tests seems like the optimal way to proceed.
