...
final class LinearSolverTests: XCTestCase {
  ...
  static var cellCount: Int { Self.gridSize * Self.gridSize * Self.gridSize }
  ...
  // TODO: Recycle the matrix generated here, so that the iterative solvers
  // can utilize it to apply the Laplacian. Transform it into a block-sparse
  // operator, with a block size of ~4-8. There should be a separate function
  // that analyzes the matrix and generates the blockmask.
        ...
        for indexX in 0..<Self.gridSize {
          ...
          for faceID in 0..<6 {
            ...
            if coordinate >= 0, coordinate < Self.gridSize {
              ...
              let linkAddress = (cellID * n + Self.cellCount) + faceID
